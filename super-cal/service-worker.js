const CACHE='super-cal-static-v20260907';
const ASSETS=['./','./index.html','./styles.css?v=20260907','./core.js?v=20260907','./app.js?v=20260907','./manifest.webmanifest?v=20260907','./icon.svg?v=20260907'];
